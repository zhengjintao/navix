...
public class ApplogController {
	...
	public Map<String, Object> queryall(DataQuery query,
		...
		try {
			...
			query = DataQuery
					.init(query,
							"navix_applog a left join navix_auth_user b on b.id=a.APPUSER",
	...
	// (AloneApplogManagerInter) BEAN("navix_applogProxyId");
	//
	// //
	// ----------------------------------------------------------------------------------
	...
	// * "SORT", "navix_menu", "ID", "PARENTID", "NAME").getResultList(),
	// * EasyUiTreeNode .queryTreeNodeTow(id, "SORT", "navix_menu", "ID",
