...
import com.navix.parameter.dao.AloneparameterlocalDaoInter;
import com.navix.parameter.dao.ParameterDaoInter;
import com.navix.parameter.domain.AloneParameter;
import com.navix.parameter.domain.Aloneparameterlocal;
import com.navix.parameter.exception.KeyExistException;
import com.navix.parameter.service.ParameterServiceInter;
...
public class ParameterServiceImpl implements ParameterServiceInter {
	...
	public List<Map<String, Object>> getTransParamList(String domainType) {
		...
		// 遍历集合，如果参数类型（navix_PARAMETER.VTYPE）是枚举值，取出枚举值转换成list集合并放入map中
	...
	public List<Map<String, Object>> getUserParameters(String userid) {
		DataQuery query = DataQuery.init(
				//
				null, //
				"navix_Parameter a left join navix_PARAMETER_LOCAL b on b.PARAMETERID=a.id", //
