...
import com.navix.parameter.dao.DictionaryEntityDaoInter;
import com.navix.parameter.dao.DictionaryTypeDaoInter;
		...
		if (types == null) {
			...
			DataQuery query = DataQuery
					.getInstance(1, "b.NAME,b.ENTITYTYPE",
							"navix_DICTIONARY_ENTITY a LEFT JOIN  navix_DICTIONARY_TYPE b ON a.ID=b.ENTITY");
