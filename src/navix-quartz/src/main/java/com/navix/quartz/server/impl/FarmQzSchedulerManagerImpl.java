package com.navix.quartz.server.impl;
...
import com.navix.quartz.dao.FarmQzSchedulerDaoInter;
...
public class FarmQzSchedulerManagerImpl implements FarmQzSchedulerManagerInter {
	...
	public DataQuery createSchedulerSimpleQuery(DataQuery query) {
		DataQuery dbQuery = DataQuery
				.init(query,
						"NAVIX_QZ_SCHEDULER A LEFT JOIN NAVIX_QZ_TASK B ON A.TASKID=B.ID LEFT JOIN navix_qz_TRIGGER C ON A.TRIGGERID=C.ID",
	...
	public DataQuery createTaskSimpleQuery(DataQuery query) {
		DataQuery dbQuery = DataQuery.init(query, "navix_qz_task",
	...
	public DataQuery createTriggerSimpleQuery(DataQuery query) {
		DataQuery dbQuery = DataQuery.init(query, "navix_qz_trigger",
