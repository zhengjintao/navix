		...
		<div class="col-xs-12">
			<form class="form-signin" role="form" id="loginFormId"
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" placeholder="请输入登录名" value="${loginname}"
				...
				<div>
					...
					<PF:IfParameterEquals key="config.sys.registable" val="true">
						<a
							...
							type="button" href="webuser/PubRegist.do"><span style="color: #D9534F;" class="glyphicon glyphicon-user">注册</span></a>
