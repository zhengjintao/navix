...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<PF:basePath/>barscan/example/css/styles.css" />
  </head>
  ...
  <body>
    ...
    <section id="container" class="container">
      ...
      <div id="interactive" class="viewport"></div>
          ...
          <footer>
        <p>
          &copy; Made with â¤ï¸ by Christoph Oberhofer
        </p>
      </footer>

    <script src="<PF:basePath/>barscan/example/vendor/jquery-1.9.0.min.js" type="text/javascript"></script>
    <script src="<PF:basePath/>barscan/example/vendor/adapter-latest.js" type="text/javascript"></script>
    <script src="<PF:basePath/>barscan/dist/quagga.js" type="text/javascript"></script>
    <script src="<PF:basePath/>barscan/example/live_w_locator.js" type="text/javascript"></script>
  </body>
</html>
