...
<title>编辑商品-<PF:ParameterValue key="config.sys.title" /></title>
...
<body>
				...
				<div class="col-md-9">
					...
					<form role="form" action="know/addsubmit.do" id="knowSubmitFormId"
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="exampleInputEmail1"> 商品分类 <span
										class="alertMsgClass">*</span>
									</label>
									<div class="row">
										<div class="col-md-9">
											<input type="text" class="form-control" id="knowtypeTitleId"
												readonly="readonly" placeholder="选择商品分类"
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label for="exampleInputEmail1"> 是否发布到店铺</label> <select
	...
	<jsp:include page="/view/navix/type/commons/includeChooseTypes.jsp"></jsp:include>
	<!-- /.modal -->
