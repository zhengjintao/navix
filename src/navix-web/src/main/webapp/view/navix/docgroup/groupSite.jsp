...
<title>${docgroup.groupname}店铺首页-<PF:ParameterValue
					...
					<div class="panel panel-default">
						<div class="panel-body">
							...
							<div class="bg-success">
								<small>店铺成立于</small> <strong> <u> <PF:FormatTime
											date="${docgroup.ctime}" yyyyMMddHHmmss="yyyy-MM-dd HH:mm" /></u>
								</strong> <small>,有</small> <strong> <u>${docgroup.usernum}</u>
								</strong> <small>人关注,商品数量</small> <strong> <u>${docnum}</u>
								</strong> <small>件</small>
							</div>
