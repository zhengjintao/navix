						...
						<tr>
							...
							<td><c:if test="${node.LEADIS=='0'}">
									...
									<a href="javascript:quitGourp('${node.GROUPUSERID}')"
										class="btn btn-danger btn-xs"> 取消关注店铺 </a>
								</c:if></td>
						</tr>
					</c:forEach>
				</table>
