...
<c:if test="${group!=null&&group.id!=null}">
	<div class="row">
		<div class="col-md-12">
			<ol class="breadcrumb">
				<li><a href="webgroup/PubHome.html">店铺</a></li>
...
<form role="form" action="${action}" id="knowSubmitFormId" method="post">
	...
	<div class="row">
		<div class="col-md-6">
			<div class="form-group">
				<label for="exampleInputEmail1"> 店铺名称 <span
			...
			<div class="form-group">
				<label for="exampleInputEmail1"> 当注册用户关注店铺时是否需要管理员审核 </label> <select
			...
			<div class="form-group">
				<label for="exampleInputEmail1"> 店铺头像(200px*200px) <span
					class="alertMsgClass">*</span>
				</label>
				<div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				<label for="exampleInputEmail1"> 店铺标签 </label> <input type="text"
					class="form-control" name="grouptag" value="${group.grouptag}"
					id="group_grouptag" placeholder="输入店铺标签,如：种类多、价格低...标签间用逗号分隔" />
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-12">
			<div class="form-group">
				<label for="exampleInputEmail1"> 店铺介绍 <span
					class="alertMsgClass">*</span>
				</label>
