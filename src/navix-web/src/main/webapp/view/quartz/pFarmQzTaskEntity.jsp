		...
		<form id="dom_formfarmqztask">
			...
			<table class="editTable">
				...
				<tr>
					...
					<td colspan="3">
						实现了org.quartz.Job接口的类（如：com.navix.quartz.test.MyJob）
						<br />
						<input class="easyui-combobox" style="width: 360px;"
							id="entity_jobclass" name="jobclass"
							value="${entity.jobclass}"
							data-options="required:true,validType:',maxLength[64]',valueField: 'value', textField: 'label', data: [{ label: '命令行任务', value: 'com.navix.quartz.job.impl.CommandRuningJob' }]" />
					</td>
				</tr>
				<tr>
					<td class="title">
