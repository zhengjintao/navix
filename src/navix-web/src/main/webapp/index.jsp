<%@page import="com.navix.doc.domain.ex.TypeBrief"%>
<%@page import="com.navix.core.util.spring.BeanFactory"%>
<%@page import="com.navix.doc.server.FarmDocTypeInter"%>
<%@page import="com.navix.doc.domain.FarmDoctype"%>
<%@ page language="java" import="java.util.*" pageEncoding="utf-8"%>
<%@ taglib uri="/view/conf/farmtag.tld" prefix="PF"%>
<%@ taglib uri="/view/conf/farmdoc.tld" prefix="DOC"%>
<%
    // example : http://127.0.0.1:8080/navix/
