...
import com.navix.web.util.ZxingTowDCode;
...
@RequestMapping("/home")
@Controller
public class HomeController extends WebUtils {
	@Resource
	...
	public ModelAndView userInfo(HttpSession session) {
		try {
			DataQuery query = DataQuery.getInstance(1, "ID,NAME,PARENTID", "navix_auth_organization");
	...
	public Map<String, Object> FPsearchKnow(String knowtitle) {
		try {
			DataQuery query = DataQuery.getInstance(1, "TITLE,ID,DOMTYPE", "NAVIX_DOC");
			if (knowtitle != null) {
